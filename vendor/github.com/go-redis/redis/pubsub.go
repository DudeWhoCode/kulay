...
func (c *PubSub) newMessage(reply interface{}) (interface{}, error) {
	...
	case []interface{}:
		...
		default:
			return nil, fmt.Errorf("redisq: unsupported pubsub message: %q", kind)
		}
	default:
		return nil, fmt.Errorf("redisq: unsupported pubsub message: %#v", reply)
	}
}
...
func (c *PubSub) receiveMessage(timeout time.Duration) (*Message, error) {
	...
	for {
		...
		case *Message:
			return msg, nil
		default:
			return nil, fmt.Errorf("redisq: unknown message: %T", msgi)
		}
	}
}
