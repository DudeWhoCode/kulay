...
var errClusterNoNodes = internal.RedisError("redisq: cluster has no nodes")
var errNilClusterState = internal.RedisError("redisq: cannot load cluster slots")
...
func (c *ClusterClient) txPipelineReadQueued(
	...
	case proto.ArrayReply:
		// ok
	default:
		err := fmt.Errorf("redisq: expected '*', but got line %q", line)
		return err
	}
