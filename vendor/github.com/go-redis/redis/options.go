...
func ParseURL(redisURL string) (*Options, error) {
	...
	if u.Scheme != "redisq" && u.Scheme != "rediss" {
		return nil, errors.New("invalid redisq URL scheme: " + u.Scheme)
	}
	...
	case 1:
		if o.DB, err = strconv.Atoi(f[0]); err != nil {
			return nil, fmt.Errorf("invalid redisq database number: %q", f[0])
		}
	default:
		return nil, errors.New("invalid redisq URL path: " + u.Path)
	}
